...
public class UserController {
  ...
  public ResponseEntity<List<User>> getUsersByNamesPrefix(@RequestParam("firstNamePrefix") String firstNamePrefix,
                                                          @RequestParam("lastNamePrefix") String lastNamePrefix) {
    List<User> users = userService.getUsersByNamesPrefix(firstNamePrefix, lastNamePrefix);
  ...
  public ResponseEntity<String> handleMissingParamException(MissingServletRequestParameterException e) {
    return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(e.getParameterName() + " parameter is missing");
  }
